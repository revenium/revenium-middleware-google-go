...
const (
	...
	ModuleName = "github.com/revenium/revenium-middleware-google-go"
...
// Format: revenium-middleware-google-go@{version}
...
func GetMiddlewareSource() string {
	middlewareSourceOnce.Do(func() {
		...
		middlewareSourceVal = "revenium-middleware-google-go@" + version
	})
...
func GetUserAgent() string {
	userAgentOnce.Do(func() {
		...
		userAgentVal = "revenium-middleware-google-go/" + version
	})
